...
BOX = [
    ...
    (17,74,30,90),(53,74,66,90),(89,74,102,90),
    (17,110,30,126),(53,110,66,126),(89,110,102,126),
    (17,146,30,162)
]

STAND = [
    [0, 7, 11, 13, 8, 4, 4, 4, 8, 13, 11, 7, 0],
    [0, 0, 4, 4, 4, 15, 15, 15, 2, 2, 2, 0, 0],
    [0, 5, 6, 7, 7, 7, 7, 8, 9, 8, 6, 0, 0],
    [0, 0, 4, 6, 6, 6, 6, 10, 14, 11, 7, 0, 0],
    [3, 4, 4, 4, 5, 5, 4, 15, 15, 15, 2, 2, 0],
    [0, 0, 9, 9, 6, 6, 7, 8, 10, 9, 6, 0, 0],
    [0, 7, 11, 13, 8, 6, 6, 6, 8, 11, 10, 5, 0],
    [0, 0, 2, 4, 6, 8, 7, 7, 6, 6, 4, 3, 0],
    [0, 4, 9, 13, 12, 7, 7, 7, 13, 12, 9, 4, 0],
    [0, 4, 10, 11, 8, 6, 6, 7, 8, 13, 11, 7, 0]
]
