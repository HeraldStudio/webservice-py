...
from mod.library.library_auth_check import LibAuthCheckHandler
...
from mod.emptyroom.new_new_handler import NewNewHandler
...
from mod.log.handler import LogHandler
import tornado.web
...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        handlers = [
            ...
            (r'/webserv2/library_auth_check', LibAuthCheckHandler),
            ...
            (r'/webserv2/newemptyroom', NewNewHandler),
            (r'/webserv2/logstat', LogHandler),
        ]
        settings = dict(
